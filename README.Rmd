...
*U* is the survival ratio by age from a life table and *f* are the age specific fertility ratios by age (see `?kin` for details). 

We can visualize the implied kin counts for an Focal aged 35 yo in a stable population using a network or 'Keyfitz' kinship diagram using the `plot_diagram` function:
