...
Kin loss has consequences related to mental health, care support and household incomes over life course. Setting `alive="no"` we can see how many relatives Ego loss during her life (output `kins_death_by_age_ego`), which of course is very realted to mortality shape by age, or the cumulated one.
...
Maybe ask what was the mean age at lost for each kin:
