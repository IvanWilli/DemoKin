...
The population of Sweden is, in reality, **non-stable**, and Ego' relatives will have been expossed to changing mortality and fertility rates.
...
```{r, fig.height=6, fig.width=8}
plot_diagramm(swe35_2015_nonstable[["kins_total"]],ego_age = 35)
```
