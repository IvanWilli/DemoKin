...
Caswell (2022) introduced two approaches for approximating two-sex kinship structures for cases when male demographic rates are not available. 
...
Here, we present a visual evaluation of the accuracy of these approximations by comparing to 'true' two-sex models using the French data included with `DemoKin` for time-invariant models (Caswell, 2022). 
