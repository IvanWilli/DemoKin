...
Now assume we have two causes of death, where the risk of the first one is half the other for females but 2/3 for males, in both cases for ages greater than 50. We need to set tow matrix with dimension 2 by 101 (number of causes by number of ages).
...
The output in this case is always the `kin_full` type. Let´s see a plot with the death distribution by age and cause of Focal´s parents when Focal is 30 yo.
